<template>
  <div class="leader-board-page">
    <h2>比赛排行榜鼠标悬停放大</h2>
    <header>
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999;" xml:space="preserve" class="icon">
        <g>
          <g>
    ...
    <main class="profiles">
      <article class="profile">
        <img :src="require('@/assets/images/hoverEffect/1.jpg')" alt="Mark Zuckerberg" class="picture">
        <span class="name">Mark Zuckerberg</span>
        <span class="value">35.7<span>B</span></span>
      </article>      
      <article class="profile">
        <img :src="require('@/assets/images/hoverEffect/2.jpg')" alt="Dustin Moskovitz" class="picture">
        <span class="name">Dustin Moskovitz</span>
        <span class="value">9.9<span>B</span></span>
      </article>      
      <article class="profile">
        <img :src="require('@/assets/images/hoverEffect/3.jpg')" alt="Elizabeth Holmes" class="picture">
        <span class="name">Elizabeth Holmes</span>
        <span class="value">4.5<span>B</span></span>
      </article>      
      <article class="profile">
        <img :src="require('@/assets/images/hoverEffect/4.jpg')" alt="Evan Spiegel" class="picture">
        <span class="name">Evan Spiegel</span>
        <span class="value">2.1<span>B</span></span>
      </article>
    </main>
  </div>
</template>
